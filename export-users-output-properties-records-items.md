...
| [phone\_extension](#phone_extension)                | `string`  | Optional | cannot be null | [export-users output](export-users-output-properties-records-items-properties-phone-extension.md "http://schema.nethserver.org/samba/export-users-output.json#/properties/records/items/properties/phone_extension")               |
...
* defined in: [export-users output](export-users-output-properties-records-items-properties-phone-extension.md "http://schema.nethserver.org/samba/export-users-output.json#/properties/records/items/properties/phone_extension")
