...
| [realm](#realm)         | `string` | Optional | cannot be null | [configure-module input](configure-module-input-properties-realm.md "http://schema.nethserver.org/samba/configure-module-input.json#/properties/realm")                  |
