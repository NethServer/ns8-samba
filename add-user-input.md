...
| [mail](#mail)                                       | Merged    | Optional | cannot be null | [add-user input](add-user-input-properties-email-address.md "http://schema.nethserver.org/samba/add-user-input.json#/properties/mail")                            |
| [phone\_extension](#phone_extension)                | `string`  | Optional | cannot be null | [add-user input](add-user-input-properties-phone-extension.md "http://schema.nethserver.org/samba/add-user-input.json#/properties/phone_extension")               |
| [must\_change\_password](#must_change_password)     | `boolean` | Optional | cannot be null | [add-user input](add-user-input-properties-must-change-password.md "http://schema.nethserver.org/samba/add-user-input.json#/properties/must_change_password")     |
| [no\_password\_expiration](#no_password_expiration) | `boolean` | Optional | cannot be null | [add-user input](add-user-input-properties-no-password-expiration.md "http://schema.nethserver.org/samba/add-user-input.json#/properties/no_password_expiration") |
...
* defined in: [add-user input](add-user-input-properties-email-address.md "http://schema.nethserver.org/samba/add-user-input.json#/properties/mail")
...
* defined in: [add-user input](add-user-input-properties-phone-extension.md "http://schema.nethserver.org/samba/add-user-input.json#/properties/phone_extension")
...
* Type: `boolean` ([Must change password](add-user-input-properties-must-change-password.md))

* cannot be null

* defined in: [add-user input](add-user-input-properties-must-change-password.md "http://schema.nethserver.org/samba/add-user-input.json#/properties/must_change_password")
...
* defined in: [add-user input](add-user-input-properties-no-password-expiration.md "http://schema.nethserver.org/samba/add-user-input.json#/properties/no_password_expiration")
