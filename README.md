...
* [import-users input](./import-users-input.md "Remove the DC from an Active Directory domain") – `http://schema.nethserver.org/samba/import-users-input.json`
...
* [Initial group membership](./import-users-input-properties-records-items-properties-initial-group-membership.md "Set the user as a member of the given list of groups") – `http://schema.nethserver.org/samba/import-users-input.json#/properties/records/items/properties/groups`
