...
Note that the full recycle bin path is private for each user. For this
reason, the `/%U` suffix is always automatically appended when generating
the corresponding Samba configuration parameter.
