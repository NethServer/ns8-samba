...
* [export-users output](./export-users-output.md "Export users and groups definitions from AD") – `http://schema.nethserver.org/samba/export-users-output.json`

* [export-users output](./validate-output-1.md) – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/export-users/validate-output.json`

* [get password policy](./validate-output-2.md) – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/get-password-policy/validate-output.json`
...
* [get-password-expiration input](./validate-input-1.md) – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/get-password-expiration/validate-input.json`

* [get-password-expiration output](./validate-output-3.md) – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/get-password-expiration/validate-output.json`
...
* [import-users input](./import-users-input.md "Import users and groups definitions in AD, with optional attribute merge behavior") – `http://schema.nethserver.org/samba/import-users-input.json`

* [import-users input](./validate-input-2.md "Import users and groups definitions in AD, with optional attribute merge behavior") – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/import-users/validate-input.json`

* [import-users output](./validate-output-4.md) – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/import-users/validate-output.json`
...
* [login input](./validate-input-3.md) – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/login/validate-input.json`
...
* [set-nbalias input](./configure-module-input.md "Change the basic configuration of the server") – `http://schema.nethserver.org/samba/configure-module-input.json`
...
* [Untitled object in export-users output](./export-users-output-properties-records-items.md) – `http://schema.nethserver.org/samba/export-users-output.json#/properties/records/items`

* [Untitled object in export-users output](./validate-output-1-defs-record-object.md) – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/export-users/validate-output.json#/$defs/record-object`
...
* [Untitled object in import-users input](./import-users-input-defs-record.md) – `http://schema.nethserver.org/samba/import-users-input.json#/$defs/record`

* [Untitled object in import-users input](./validate-input-2-defs-record.md) – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/import-users/validate-input.json#/$defs/record`
...
* [Untitled array in export-users output](./export-users-output-properties-records.md) – `http://schema.nethserver.org/samba/export-users-output.json#/properties/records`

* [Untitled array in export-users output](./export-users-output-properties-records-items-properties-groups.md "List of groups") – `http://schema.nethserver.org/samba/export-users-output.json#/properties/records/items/properties/groups`

* [Untitled array in export-users output](./validate-output-1-properties-records.md) – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/export-users/validate-output.json#/properties/records`

* [Untitled array in export-users output](./validate-output-1-defs-record-object-properties-groups.md "List of groups") – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/export-users/validate-output.json#/$defs/record-object/properties/groups`
...
* [Untitled array in import-users input](./import-users-input-properties-records.md) – `http://schema.nethserver.org/samba/import-users-input.json#/properties/records`

* [Untitled array in import-users input](./import-users-input-defs-record-properties-groups.md "List of initial groups") – `http://schema.nethserver.org/samba/import-users-input.json#/$defs/record/properties/groups`

* [Untitled array in import-users input](./validate-input-2-properties-records.md) – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/import-users/validate-input.json#/properties/records`

* [Untitled array in import-users input](./validate-input-2-defs-record-properties-groups.md "List of initial groups") – `http://schema.nethserver.org/ns8-samba/api-moduled/handlers/import-users/validate-input.json#/$defs/record/properties/groups`
