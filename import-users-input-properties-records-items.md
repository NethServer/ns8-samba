...
| [display\_name](#display_name)                      | `string`  | Optional | cannot be null | [import-users input](import-users-input-properties-records-items-properties-display-name.md "http://schema.nethserver.org/samba/import-users-input.json#/properties/records/items/properties/display_name")                     |
...
* Type: `string` ([Display name](import-users-input-properties-records-items-properties-display-name.md))

* cannot be null

* defined in: [import-users input](import-users-input-properties-records-items-properties-display-name.md "http://schema.nethserver.org/samba/import-users-input.json#/properties/records/items/properties/display_name")

### display\_name Type

`string` ([Display name](import-users-input-properties-records-items-properties-display-name.md))
...
True, if the user account is locked, preventing the user from logging in
