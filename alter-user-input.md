...
| [phone\_extension](#phone_extension)                | `string`  | Optional | cannot be null | [alter-user input](alter-user-input-properties-phone-extension.md "http://schema.nethserver.org/samba/alter-user-input.json#/properties/phone_extension")               |
...
* defined in: [alter-user input](alter-user-input-properties-phone-extension.md "http://schema.nethserver.org/samba/alter-user-input.json#/properties/phone_extension")
