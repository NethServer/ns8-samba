# Display name, if missing User identifier is applied with Title Case Schema

```txt
http://schema.nethserver.org/samba/import-users-input.json#/properties/records/items/properties/display_name
```
